# Soal 3 : Hasil dari Sigma 5-(i/2)**2 dengan i=1 dan n=terserah ( karena "n"nya gak ditentuin plis)
...
for i in range(1, n+1):  # range harus sampai n, jadi gunakan n + 1
    total_sum += 5 - ( i / 2)**2 # masukan rumus
...
for i in range(1, n+1):  # range harus sampai n, jadi gunakan n + 1
    rumus = 5 - ( i / 2)**2 #masukan rumus notasi sigma
